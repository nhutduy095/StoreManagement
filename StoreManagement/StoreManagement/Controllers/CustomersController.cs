...
namespace StoreManagement.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CustomerName,CustomerCd,Email,Address,PhoneNumber,CreateBy,UpdateBy,CreateDate,UpdateDate,Active")] Customers customers)
        {
